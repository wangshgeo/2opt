...
public:
        ...
        static coordType calculateTourLength(const Instance& instance, tourContainer cur_tour);
        ...
        coordType getTourLength() const { return tour_length; }
        double getRuntime() const { return runtime; }
        //setters
        void setTourLength(coordType value) { tour_length = value; }
